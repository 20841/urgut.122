...
// 						<p className='text-gray-700'>Shipping-Xizmat-haqqi</p>
// 						<p className='text-gray-700'>{(10).toLocaleString('en-US', {currency: 'usd', style: 'currency'})}</p>
// 					</div>
// 					<hr className='my-4' />
// 					<div className='flex justify-between'>
// 						<p className='text-lg font-bold'>Total <br /> Jami</p>
// 						<div className=''>
    ...
    <>
      {products.length ? (
        <div className="min-h-screen bg-gray-100 pt-20">
          ...
          <div className="mx-auto max-w-7xl px-6 md:flex md:space-x-6 xl:px-8">
            <div className="rounded-lg md:w-2/3">
              {products.map((product) => (
                <div
                  key={product.id}
                  className="mb-6 rounded-lg bg-white p-6 shadow-md flex flex-col sm:flex-row sm:justify-between items-center"
                >
                  <div className="relative w-full sm:w-52 h-52 sm:h-auto">
                    <CustomImage product={product} fill />
                  </div>
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between sm:items-center">
                    ...
                    <div className="mt-4 flex sm:mt-0 sm:space-x-6">
                      <div className="flex items-center border-gray-100">
                        <span
